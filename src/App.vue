...
<v-navigation-drawer
    ...
    >
      <v-list>
        <v-list-tile
          ...
          <v-list-tile-content color="info">{{ item.title }}</v-list-tile-content>
        </v-list-tile>
      </v-list>
    </v-navigation-drawer>
  ...
  <v-footer fixed class="hidden-sm-and-down" color="info">
    <v-container>
      <v-spacer></v-spacer>
      <h3>&copy; Ladeez First Media {{ new Date().getFullYear() }}</h3>
    </v-container>
  </v-footer>
  </v-app>
</template>
